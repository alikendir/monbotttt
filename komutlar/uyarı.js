...
exports.run = async (client, message, args) => {
 ...
 if(!message.member.roles.cache.some(r => ["783342079597215754","783342083490316298","783342075910422548"].includes(r.id)));
...
//
  ...
  if(!kullanıcı) return message.channel.send(` Kimi Uyarmak İstiyorsun ?`)
